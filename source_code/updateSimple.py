...
def updateEngine(root_directory, backup_folder, folder_scan):
    ...
    for eachfoldr in folder_scan:   #what is present in new and not in old
    ...
    for each in new_files:    #deleting all the empty folder in files to copy
    ...
    for each in old_files:  #delete all the empty folder in files to archive
